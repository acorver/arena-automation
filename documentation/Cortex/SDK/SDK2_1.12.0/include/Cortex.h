...
/** Data for CamTrack calibration parameters
*/
typedef double tCamTrackParameters[14]; //! 
//	Parameters listed in scrollable Camtrak properties + distortion coefficient
//	Offset X			X, Y, Z offset and angle (segment to 'pinhole')
//	Offset Y
//	Offset Z
//	Offset Angle X		
//	Offset Angle Y
//	Offset Angle Z
//	Video Width			Sensor size (width and height)
//	Video Height
//	Optical Center X	Pixel location on sensor
//	Optical Center Y
//	Field-of-view X		FOV in degrees
//	Field-of-view Y	
//	Pixel Aspect		Pixel aspect ratio
//	First coefficient	k1 (Lens distortion)
...
typedef struct sBodyData
{
	...
	tCamTrackParameters CamTrackParams;  //!< Array of CamTrack calibration parameters (double X 14)
