...
Feb 2014  Daniel Koch Added function to specify multicast port number
...
/**   This function specifies the port on which Cortex listens for commands.
 *
 *    Newer versions of Cortex allow the user to choose on which port
 *    Cortex listens for commands. This function allows you to tell the
 *    SDK which port to send commands to. This function must be called
 *    before Cortex_Initialize() is called.
 *
 *  \param port - The port number to use for the multicast port
 *
 *  \return maReturnCode - RC_Okay
 *
 *    Notes: This function was added to the SDK by Daniel Koch on 10 Feb 2014
 *    as part of his work on creating the cortex_ros ROS node.
 */
int Cortex_SetCortexPort(const unsigned short port);

//==================================================================

/**   This function specifies the multicast port on which Cortex will stream data.
 *
 *    Newer versions of Cortex allow the user to choose on which port
 *    Cortex will stream data. This function allows you to tell the
 ...
 *    as part of his work on creating the cortex_ros ROS node.
 */
int Cortex_SetMultiCastPort(const unsigned short port);
